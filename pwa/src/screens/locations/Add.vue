      ...
      <form class="mt-6 w-full max-w-3xl" @submit.prevent="submitForm">
        ...
        <div class="mt-3">
          ...
          >
            ...
            <span class="sr-only">A mp view to slect the location of the observed bird</span>
            <MapView class="rounded-md" :map-coordinates="{lng: 3.3232699, lat: 50.8425729} " @coordinateSelection ="locationInput.location = $event"/>
          </label>
        </div>
